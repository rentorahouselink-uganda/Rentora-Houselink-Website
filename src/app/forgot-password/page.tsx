    ...
    <main className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 py-12 px-4 sm:px-6 lg:px-8 selection:bg-emerald-100 selection:text-emerald-900">
      <div className="w-full max-w-md space-y-12">
        ...
        <div className="space-y-4">
          <EnvelopeIcon className="h-8 w-8 text-zinc-400 dark:text-zinc-600 mb-4" strokeWidth={1} />
          <h1 className="text-3xl font-light tracking-wide text-zinc-900 dark:text-white">
            Forgot your password?
          </h1>
          <p className="text-base text-zinc-500 dark:text-zinc-400 tracking-wide">
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-10">
            ...
            <button 
              type="submit" 
              disabled={loading} 
              className="flex w-full items-center justify-center gap-3 rounded-none bg-emerald-600 py-4 text-sm font-bold uppercase tracking-widest text-white transition-colors hover:bg-emerald-700 focus:outline-none dark:bg-emerald-500 dark:hover:bg-emerald-400 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading && (
