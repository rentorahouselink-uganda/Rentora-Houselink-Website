...
export function MobileAppBanner() {
  ...
  // Android Intent: Tries to open the app. If missing, automatically falls back to Play Store app.
  ...
  // If on Android, use the intent. If on Desktop/Mac, just link to the Play Store website.
  const linkHref = isAndroid ? androidIntentUrl : playStoreUrl;
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-xs font-medium text-zinc-500 dark:text-zinc-400">
            {isAndroid ? "Better experience on the app" : "Get the Android App"}
          </span>
        </div>
      </div>
