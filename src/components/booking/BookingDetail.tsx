...
// Maps billing cycle enum → readable label for the detail page
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <p className="mt-2 text-sm leading-relaxed text-slate-600">
          This will send a cancellation request to the landlord. The action
          cannot be undone.
        </p>
        {error && (
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-5">
          <div className="aspect-video animate-pulse rounded-2xl bg-slate-200 lg:col-span-3" />
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
        <div className="text-center">
          ...
          <Link
            href="/bookings"
            className="mt-5 inline-block rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white"
          >
            Back to My Bookings
          </Link>
        </div>
          ...
          <div className="grid gap-8 lg:grid-cols-5">
            ...
            <div className="lg:col-span-3">
              ...
              <Link
                ...
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-300 hover:shadow-sm"
              >
            ...
            <div className="flex flex-col gap-5 lg:col-span-2">
              ...
              <div>
                <div className="flex items-start gap-3">
                  <h1 className="flex-1 text-xl font-extrabold capitalize leading-snug text-slate-900">
                    {booking.propertyTitle.toLowerCase()}
                  </h1>
                  {booking.roomNumber && (
                    <span className="mt-0.5 shrink-0 rounded-lg bg-emerald-50 px-2.5 py-1 text-xs font-bold text-emerald-700">
              ...
              <div className="space-y-2.5">
                ...
                {booking.universityName && (
                  <div className="flex items-start gap-3 rounded-xl border border-slate-100 bg-white p-4">
                    <AcademicCapIcon className="mt-0.5 h-4 w-4 shrink-0 text-slate-400" />
                    <div>
                      <p className="text-[11px] font-bold uppercase tracking-wide text-slate-400">
                        Nearest University
                      </p>
