...
export function PropertyCard({ property }: { property: Property }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-[12px] border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-emerald-400 hover:shadow-lg"
    ...
    >
      ...
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-slate-100">
        ...
        {/* ── Nice Center Play Button Overlay ── */}
        {hasVideo && (
          <div
            className={[
        ...
        <div className="absolute left-3 top-3 flex flex-col items-start gap-2">
          {property.isFeatured && (
            <span className="inline-flex items-center gap-1 rounded-md bg-emerald-600 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-white shadow-sm">
        ...
        <button
          ...
          className="absolute right-3 top-3 grid h-8 w-8 place-items-center rounded-full bg-white/90 text-slate-400 shadow-sm backdrop-blur-md transition hover:text-rose-500"
        >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-auto pt-4">
          <div className="flex items-center justify-between rounded-lg bg-slate-50 p-2.5 text-xs font-medium text-slate-600">
            ...
            <span className="h-3 w-px bg-slate-200" />
            <span className={property.status === "AVAILABLE" ? "text-emerald-600" : ""}>
